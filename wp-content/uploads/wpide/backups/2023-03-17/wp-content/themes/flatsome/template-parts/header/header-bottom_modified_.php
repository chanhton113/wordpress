    ...
    <div class="flex-row container">
            ...
            <div class="flex-col hide-for-medium flex-left">
                <ul class="nav header-nav header-bottom-nav nav-left <?php flatsome_nav_classes('bottom'); ?>">
                    <li><a href="http://localhost:8080/Wordpress/" title="Organic Store" rel="home">
                        <img width="22" height="22" src="http://localhost:8080/Wordpress/wp-content/uploads/2023/03/icons8-home-64-1.png" >
                    </a></li>
